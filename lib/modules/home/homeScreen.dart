                ...
                Container(
                  ...
                  child: ListView.separated(
                      ...
                      itemBuilder: (context , index) => TextButton(
                        ...
                        child: Card(
                          elevation: 10,
                          child: myText(text: cubit.categories!.data[index].category!, size: 22)
                        ),
                      ) ,
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  myText(text: cubit.all_services!.services[index].Service_name!, size: 23),
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.end,
                                    children: [
                                      defaultButton(function: (){
                                        myShowDialog(context: context, nbrButtons: 2, message: 'Confirme Reservation', btn1: 'Confirme', bt1Pressed: (){
                                          cubit.registerDate(
                                              token: 'Bearer $token',
                                              serv_id: cubit.all_services!.services[index].Service_name
                                          );
                                          Navigator.of(context).pop();
                                        }, btn2: 'Exit',colorBtn2: Colors.red[400],
                                            bt2Pressed: (){
                                          Navigator.of(context).pop();
                                        },  colorBtn1: Colors.green);
                                      }, text: 'Reserve',width: 110,textColor: Colors.black,textSize: 18,radius: 10),
                                      SizedBox(width: 10,)
                                    ],
                                  )
                                ],
